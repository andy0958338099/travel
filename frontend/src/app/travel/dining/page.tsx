...
六點半開始人多起來，穿拖鞋的、跑步的、開車路過的，都是熟面孔。我在這裡吃到了杭州最地道的早餐——沒有網紅店的光環，但有的是時間積累出來的味道。`,
  ...
  },
  {
    ...
    rating: 4.3,
    reviewCount: 892,
    tags: ['東坡肉', '竹林環境', '在地私房', '時令菜'],
    story: `打車到虎跑路56號，司機師傅回頭看了我一眼：「這家餐廳我知道，但你去過就知道了，很難找。」他說得對。我沿著小路往山坡上走，兩邊是竹林，空氣里有桂花香和泥土味，完全不像在城市裡。

餐廳藏在一個小花園後面，門口沒有太大的招牌，就是木頭的招牌上寫著「馬蹤興」三個字。進去後發現是一個改造過的老宅院，青磚牆、木門窗，窗戶外面就是小山坡和竹林。

老闆親自出來迎接，五十多歲的大叔，說這家店是他爸留下來的事業。菜單是手寫的，沒有圖片，只有菜名和老闆的鉛筆標注。我問他推薦什麼，他說：「東坡肉是每桌必點，但一個人吃一塊會太膩，兩個人吃一塊剛好。再加一個清蒸鱸魚，這是我們錢塘江的。」

東坡肉上桌的時候，我視覺受到的衝擊比味覺更大——一塊大約拳頭大小的五花肉，肥瘦三七開，顏色紅亮髮光。入口的一瞬間，脂肪融化、瘦肉酥爛，鹹中帶甜的調味剛好，一塊根本不夠。錢塘江鱸魚清蒸，火候掌握得很好，魚肉細嫩，沒有任何腥味。

這是一家需要預期心理準備的餐廳——環境低調、味道高調。適合帶重要的客人或特別的日子來。`,
    dishes: [
      { name: '東坡肉（馬蹤興）', price: '¥68', note: '一塊約200g，肥瘦三七開，入口即化', img: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800&q=80' },
      { name: '清蒸鱸魚', price: '¥98/斤', note: '錢塘江野生鱸魚，清蒸最鮮', img: 'https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=800&q=80' },
      { name: '竹籬雞（半隻）', price: '¥88', note: '放養竹林雞，肉質結實鮮美', img: 'https://images.unsplash.com/photo-1565557629238-35c4c7c4a9e8?w=800&q=80' },
      { name: '宋嫂魚羹', price: '¥48', note: '傳統杭幫名菜，酸辣適中', img: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800&q=80' },
      { name: '東坡筍', price: '¥38', note: '春季限定，筍尖配東坡肉汁', img: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80' },
    ],
    images: [
    ...
    menu: {
      ...
      '🥬 時蔬': [
        { item: '東坡筍（春季）', price: '¥38' },
        { item: '香椿炒蛋', price: '¥32' },
        { item: '馬蘭頭拌香干', price: '¥28' },
      ],
    },
    tips: '餐廳比較隱蔽，建議打車到「虎跑路56號」然後看路牌。路有點不好找，但去過的人都說值得。老闆會推薦當日特色菜，聽他的不會失望。請預訂，現場去大概率要等位。帶長輩的話建議預訂包間。',
    ratingDetail: '味道★★★★★ 環境★★★★★ 在地感★★★★★ 隱密度★★★★',
  },
  {
    id: 'act-24',
    day: 7,
