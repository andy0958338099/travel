...
export const ATTRACTIONS: { westLake: Attraction[]; wuzhen: Attraction[]; other: Attraction[] } = {
  ...
  other: [
    ...
    // ── 上海新品（2026-05-16 新行程）─────────────────────
    { name: "南京東路步行街", nameEn: "Nanjing East Road Pedestrian Street", ticket: "免費", hours: "24小時開放", highlight: "上海最繁華商業街，百貨商場林立，建議傍晚前往", lat: 31.2370, lng: 121.4905, category: 'other', images: ["/attractions/sh05-1.jpg", "/attractions/sh05-best1.jpg"] }, // 共用 sh05 夜景（同南京東路 / 外灘 1 公里內、共享同一片天際線）
    ...
    // TODO: 椒鹽醄醄火鍋目前借用 sh10 (水宴) / sh09 (江南戲曲) 圖檔, 需重新拍攝或下載獨立圖
    ...
    // TODO: 南京東路步行街目前共用 sh05 (外灘夜景) 編號, 需重新指派獨立 sh11 編號並下載專屬圖
    // ── 杭州新品（2026-05-16 新行程）─────────────────────
