...
# 🆕 2026-08-16 聖上拍板: 輸出語言統一繁體中文 (台灣用詞)
- 全文必須用「繁體中文」, 不准出現簡體字
- 禁用簡體字對照: ❌ 时→時、个→個、们→們、说→說、这→這、里→裡、吗→嗎、间→間、动→動、听→聽、见→見、觉→覺、应→應、对→對、际→際、议→議、响→響、团→團、园→園、环→環、丽→麗、术→術、积→積、确→確、记→記、号→號、顾→顧、财→財、车→車、长→長、阵→陣、银→銀 → 必須用繁體
...
- 不要洗成文學腔 (例: 別寫「歲月靜好」「時光流淌」「人間煙火」這類詞, 阿喜是口述記錄不是作家散文)
